...
x1_Temp_height=list(np.squeeze(height_x1_D * (np.array(x1_Temp_height)-height_threshold_interval1)/height_len_interval1))
...
x2_Temp_height=list(np.squeeze(height_x2_D * ((np.array(x2_Temp_height)-height_threshold_interval2)/height_len_interval2)+ height_x1_D))
...
x3_Temp_height=list(np.squeeze(height_x3_D * ((np.array(x3_Temp_height)-height_threshold_interval3)/height_len_interval3)+ height_x1_D + height_x2_D))
...
x3_Temp_height=list(sum_Temp[len(x1_Temp_height)+len(x2_Temp_height):len(x1_Temp_height)+len(x2_Temp_height)+len(x3_Temp_height)])
...
X_features=np.concatenate((X_features, np.expand_dims(np.concatenate((x1_matrix, x2_matrix, x3_matrix), axis=0),axis=2)), axis=2)
...
x1_Temp_weight=list(np.squeeze(weight_x1_D * ((np.array(x1_Temp_weight)-weight_threshold_interval1)/weight_len_interval1)))
x2_Temp_weight=list(np.squeeze(weight_x2_D * ((np.array(x2_Temp_weight)-weight_threshold_interval2)/weight_len_interval2)+ weight_x1_D))
x3_Temp_weight=list(np.squeeze(weight_x3_D * ((np.array(x3_Temp_weight)-weight_threshold_interval3)/weight_len_interval3)+ weight_x1_D+weight_x2_D))
x4_Temp_weight=list(np.squeeze(weight_x4_D * ((np.array(x4_Temp_weight)-weight_threshold_interval4)/weight_len_interval4)+ weight_x1_D+weight_x2_D+weight_x3_D))

# 二次归一化
sum_Temp_weight=MinMax.fit_transform(np.array(x1_Temp_weight + x2_Temp_weight + x3_Temp_weight + x4_Temp_weight).reshape(-1,1))
...
x3_Temp_weight=list(sum_Temp_weight[len(x1_Temp_weight)+len(x2_Temp_weight):len(x1_Temp_weight)+len(x2_Temp_weight)+len(x3_Temp_weight)])
x4_Temp_weight=list(sum_Temp_weight[len(x1_Temp_weight)+len(x2_Temp_weight)+len(x3_Temp_weight):len(x1_Temp_weight)+len(x2_Temp_weight)+len(x3_Temp_weight)+len(x4_Temp_weight)])
...
# 一次归一化
heightfundusuterus_x1_D=int(500*len(dict(Counter(x1_Temp_heightfundusuterus)).keys())/(max(x1_Temp_heightfundusuterus)-min(x1_Temp_heightfundusuterus)))
heightfundusuterus_x2_D=int(500*len(dict(Counter(x2_Temp_heightfundusuterus)).keys())/(max(x2_Temp_heightfundusuterus)-min(x2_Temp_heightfundusuterus)))
heightfundusuterus_x3_D=int(500*len(dict(Counter(x3_Temp_heightfundusuterus)).keys())/(max(x3_Temp_heightfundusuterus)-min(x3_Temp_heightfundusuterus)))

x1_Temp_heightfundusuterus=list(np.squeeze(heightfundusuterus_x1_D * ((np.array(x1_Temp_heightfundusuterus)-heightfundusuterus_threshold_interval1)/heightfundusuterus_len_interval1)))
x2_Temp_heightfundusuterus=list(np.squeeze(heightfundusuterus_x2_D * ((np.array(x2_Temp_heightfundusuterus)-heightfundusuterus_threshold_interval2)/heightfundusuterus_len_interval2)+ heightfundusuterus_x1_D))
x3_Temp_heightfundusuterus=list(np.squeeze(heightfundusuterus_x3_D * ((np.array(x3_Temp_heightfundusuterus)-heightfundusuterus_threshold_interval3)/heightfundusuterus_len_interval3)+ heightfundusuterus_x1_D+heightfundusuterus_x2_D))

# 二次归一化
sum_Temp_heightfundusuterus=MinMax.fit_transform(np.array(x1_Temp_heightfundusuterus + x2_Temp_heightfundusuterus + x3_Temp_heightfundusuterus).reshape(-1,1))
x1_Temp_heightfundusuterus=list(sum_Temp_heightfundusuterus[:len(x1_Temp_heightfundusuterus)])
x2_Temp_heightfundusuterus=list(sum_Temp_heightfundusuterus[len(x1_Temp_heightfundusuterus):len(x1_Temp_heightfundusuterus)+len(x2_Temp_heightfundusuterus)])
x3_Temp_heightfundusuterus=list(sum_Temp_heightfundusuterus[len(x1_Temp_heightfundusuterus)+len(x2_Temp_heightfundusuterus):len(x1_Temp_heightfundusuterus)+len(x2_Temp_heightfundusuterus)+len(x3_Temp_heightfundusuterus)])
...
for i in range(len(heightfundusuterus_check_num)):
    heightfundusuterus_matrix.append(list(Temp_heightfundusuterus_new[heightfundusuterus_count:heightfundusuterus_check_num[i]+heightfundusuterus_count]))
...
x1_Temp_abdom=list(np.squeeze(abdom_x1_D * ((np.array(x1_Temp_abdom)-abdom_threshold_interval1)/abdom_len_interval1)))
x2_Temp_abdom=list(np.squeeze(abdom_x2_D * ((np.array(x2_Temp_abdom)-abdom_threshold_interval2)/abdom_len_interval2)+ abdom_x1_D))
x3_Temp_abdom=list(np.squeeze(abdom_x3_D * ((np.array(x3_Temp_abdom)-abdom_threshold_interval3)/abdom_len_interval3)+ abdom_x1_D+abdom_x2_D))
...
x3_Temp_abdom=list(sum_Temp_abdom[len(x1_Temp_abdom)+len(x2_Temp_abdom):len(x1_Temp_abdom)+len(x2_Temp_abdom)+len(x3_Temp_abdom)])
...
#把早产史和高危放到后面
X_features=np.concatenate((np.array(X_features),np.array(X_features[:,:,7]).reshape(np.array(X_features[:,:,7]).shape[0],
                                                         np.array(X_features[:,:,7]).shape[1],
                                                         1)),axis=2)
print(X_features.shape)

X_features=np.concatenate((np.array(X_features),np.array(X_features[:,:,8]).reshape(np.array(X_features[:,:,8]).shape[0],
                                                         np.array(X_features[:,:,8]).shape[1],
                                                         1)),axis=2)
print(X_features.shape)

X_features=np.concatenate((np.array(X_features),np.array(X_features[:,:,9]).reshape(np.array(X_features[:,:,9]).shape[0],
                                                         np.array(X_features[:,:,9]).shape[1],
                                                         1)),axis=2)
print(X_features.shape)

X_features=np.concatenate((np.array(X_features),np.array(X_features[:,:,10]).reshape(np.array(X_features[:,:,10]).shape[0],
                                                         np.array(X_features[:,:,10]).shape[1],
                                                         1)),axis=2)
print(X_features.shape)

X_features=np.concatenate((np.array(X_features),np.array(X_features[:,:,11]).reshape(np.array(X_features[:,:,11]).shape[0],
                                                         np.array(X_features[:,:,11]).shape[1],
                                                         1)),axis=2)
print(X_features.shape)

X_features=np.concatenate((np.array(X_features),np.array(X_features[:,:,12]).reshape(np.array(X_features[:,:,12]).shape[0],
                                                         np.array(X_features[:,:,12]).shape[1],
                                                         1)),axis=2)
print(X_features.shape)

X_features=np.concatenate((np.array(X_features),np.array(X_features[:,:,13]).reshape(np.array(X_features[:,:,13]).shape[0],
...
y3_new=list(np.squeeze(y3_D * ((np.array(y3)-fetal_threshold_interval3)/fetal_len_interval3) + y1_D + y2_D))
...
for i in range(Y_labels.shape[0]):
    ...
    if 86 * Y_labels[i] > 21 and 86 * Y_labels[i] <= 72:
        Y_labels_restore.append((86*Y_labels[i] - y1_D) / y2_D * fetal_len_interval2 + fetal_threshold_interval2)

    if 86 * Y_labels[i] > 72 and 86 * Y_labels[i] <=86:
        Y_labels_restore.append((86*Y_labels[i] - y1_D - y2_D) / y3_D * fetal_len_interval3 + fetal_threshold_interval3)
